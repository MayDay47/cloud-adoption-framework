...
Don't deploy more than 5,000 VMs in a single region per subscription. You can accommodate extra user sessions by increasing individual session host VM resources, or by using multiple subscriptions.
